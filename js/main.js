...
function clickSelect () {
    if (clicked == null) {$("#selector").append(`<select id="color"><option value=""></option><option value="negro">Negro</option>
    <option value="Lila">Lila</option></select><select><option value="L">Large</option>
                            <option value="M">Medium</option></select>
